      ...
      <div style={shellStyle}>
        ...
        <section style={heroStyle}>
          <div>
            ...
            <p style={leadStyle}>Internships come through the backend JSearch integration. Hackathons come from Hack Club&apos;s public upcoming event feed and are cached by FastAPI.</p>
          </div>
    ...
    <section style={panelStyle}>
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, alignItems: 'flex-start', marginBottom: 16 }}>
        <div>
          ...
          <p style={{ ...mutedTextStyle, margin: 0 }}>Source: {data?.hackathon_meta.source || 'Hack Club upcoming events'}</p>
        </div>
